defmodule HerokuConnector.Plug.CurrentAccountTest do
  use ExUnit.Case, async: true
  use Plug.Test

  alias HerokuConnector.Account
  alias HerokuConnector.Plug.CurrentAccount
  ...
  setup do
    ...
    HerokuConnector.Repo.insert!(account)
  ...
  test "redirect if there is no account in the session", %{conn: conn} do
    ...
    assert Phoenix.ConnTest.redirected_to(conn) == HerokuConnector.Router.Helpers.dnsimple_oauth_path(conn, :new)
  end
end
